...
const ApprovedProductsPage = () => {
  ...
  return (
    <Container>
      <PageHeader title="Approved Products" total={approvedProducts.length} totalLabel="Total" />

      {loading ? (
        <Loader />
      ) : approvedProducts.length === 0 ? (
        <EmptyState title="No approved products" subtitle="Products you approve will appear here." />
      ) : (
